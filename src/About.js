    ...
    return (
      <div>
        ...
        <div className="howstatement">
          ...
          <div className="typeright">
            ...
            <div className="titlepage usptext subtext abouttext">
              ...
              <br />For Pink Parrot&#x27;s co-founders, Instagram is the present
              and the future of our career.<br />
              <strong>
        ...
        <div className="whatstatement">
          <div className="titleholder_bacon">
            ...
            <h1 className="titlepage aboutsubtitle">
              Bacon. Success. Rocket. Texts on websites can be annoyingly vague.
              Let&#x27;s talk features.
            </h1>
          </div>
          <div className="usp_wrap about_page_wrap">
            <div id="w-node-9ca96e144d5d-8be6e562" className="usp">
              ...
              <div className="titlepage usptext subtext">
                <strong>Most Secure -</strong> It&#x27;s one of the main reasons
                bot users get banned nowadays:{' '}
                <em>
            ...
            <div id="w-node-9ca96e144d65-8be6e562" className="usp">
              ...
              <div className="titlepage usptext subtext">
                ...
                <em>
                  The conversion - be it a sale, a new fan or whatnot - comes
                  from reaching the right people at the right time.<br />
                </em>Pink Parrot&#x27;s interface lets you target people already
                interested in your content in every relevant detail. So you can
                organically increase your reach and business. Reach new career
                stages and cooperations!<br />
              </div>
            </div>
            <div id="w-node-9ca96e144d6d-8be6e562" className="usp bottomusp">
              <div className="uspicon privacyicon" />
              <div className="titlepage usptext">Privacy</div>
              <div className="titlepage usptext subtext">
                <strong>Privacy -</strong> a service like ours needs to remotely
                control your Instagram account. That&#x27;s how it can like,
                comment and follower other accounts for instance. Meaning,{' '}
                <em>we need your Instagram password.</em>
                <br />But we only save it on your device and not on our servers!
                Meaning, even we couldn&#x27;t access it if we wanted to.<br />
              </div>
            </div>
            <div id="w-node-9ca96e144d75-8be6e562" className="usp bottomusp">
              <div className="uspicon alwaysonicon" />
              <div className="titlepage usptext">Bot works. Whenever.</div>
              <div className="titlepage usptext subtext">
                <strong>Always on -</strong>{' '}
                <em>
                  Why should you be required to keep your device on in order to
                  make your bot run?
                </em>
                <br />We put Pink Parrot on a server. You adjust the settings,
                schedule when the bot&#x27;s supposed to be active (to target
                your target group better and so it becomes more human-like) and
                lean back.
              </div>
            </div>
          </div>
        ...
        <div className="contact">
          <h1 className="titlepage featurestitle contacttitle">Questions?</h1>
