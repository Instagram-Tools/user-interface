          ...
          <div>
            ...
            <div className="actvityholder">
              ...
              <div className="tableholder">
                <div className="columnholder weekplan">
                  <div className="_4row w-row">
                    <div className="week_schedule_column w-col w-col-3" />
                    <div className="week_schedule_column _2nd w-col w-col-3" />
                    <div className="week_schedule_column w-col w-col-3" />
                    <div className="week_schedule_column _2nd w-col w-col-3" />
                  </div>
                  <div className="_3row w-row">
                    <div className="week_schedule_column w-col w-col-4" />
                    <div className="week_schedule_column _2nd w-col w-col-4" />
                    <div className="week_schedule_column w-col w-col-4" />
                  </div>
                </div>
                <div className="columnholder weekplan">
                ...
                <div className="columnholder weekplan">
                  <div className="_4row w-row">
                    <div className="week_schedule_column ifclicked w-col w-col-3" />
                    <div className="week_schedule_column _2nd w-col w-col-3" />
                    <div className="week_schedule_column w-col w-col-3" />
                    <div className="week_schedule_column _2nd w-col w-col-3" />
                  </div>
